...
public class SignUpController {
    ...
    public SignUpCheck signup(@RequestParam(value = "id") String id, @RequestParam(value = "name") String name, @RequestParam(value = "sex") int sex,
                              @RequestParam(value = "phone_num") String phone_num, @RequestParam(value = "password") String password, @RequestParam(value = "role") int role, @RequestParam(value = "birthday") String date, HttpSession httpSession) {
